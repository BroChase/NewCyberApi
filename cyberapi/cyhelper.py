...
class SearchHelper:
    ...
    def __init__(self, searchframe):
        ...
        # author
        self.author_label = Label(searchframe, text='Author:', background='#282828', font=15, foreground='#5DE0DC')
        ...
        # subjectivity
        self.fsub_label = Label(searchframe, text='Subjectivity:', background='#282828', font=15, foreground='#5DE0DC')
        ...
        # date
        self.fD_label = Label(searchframe, text='Date:', background='#282828', font=15, foreground='#5DE0DC')
