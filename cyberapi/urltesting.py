...
class cyberapi(Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (SearchFrame, Welcome, searchtitlekeyword):       #The two windows used in program sets the page
...
class SearchFrame(Frame):
    ...
    def tkwsearch(self):
        ...
        self.titlelabel = Label(self, text='Title')
        self.but_search = Button(self, text='Search', width=20, state='disable', command=lambda: self.search(
    ...
    def tbssearch(self):
        ...
        self.but_search = Button(self, text='Search', width=20, state='disable', command=lambda: self.search(
            'http://cbrown686-test.apigee.net/cyberapi/articles?q=keywordbody&title='
    ...
    def sbdsearch(self):
        ...
        self.but_search = Button(self, text='Search', width=20, state='disable', command=lambda: self.search(
            'http://cbrown686-test.apigee.net/cyberapi/articles?q=date&adate='
            + self.ent_date.get() + '&zdate=' + self.ent_edate.get()))
        # http://cbrown686-test.apigee.net/cyberapi/articles?q=date&adate='00/00/0000'&zdate='00/00/0000
        # + &author='string'&+&sub=gt&sdate='00/00/0000&edate='00/00/0000'
